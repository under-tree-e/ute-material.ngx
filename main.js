...
const AppRoutes = [{
  path: "",
  pathMatch: "full",
  loadComponent: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_pages_home_index_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/home */ 4144)).then(m => m.HomePage)
}, {
  path: "get-started",
  data: {
    id: "get-started",
  ...
  loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_pages_layout_index_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/layout */ 8188)).then(m => m.LayoutModule)
}, {
  path: "about-us",
  data: {
    id: "about-us",
  ...
  path: "404",
  loadComponent: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_pages_not-found_index_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/not-found */ 9656)).then(m => m.NotFound)
}, {
  path: "**",
  redirectTo: "/404"
}];
...
module.exports = /*#__PURE__*/JSON.parse('{"name":"ngx-ute-material","version":"1.2.2","description":"Ute material addon for Angular material library","keywords":["angular","material","typescript","es5","datepicker-time","datetime","timepicker"],"license":"MIT","peerDependencies":{"@angular/common":">=16.0.0","@angular/core":">=16.0.0","@angular/material":">=16.0.0","rxjs":">=7.0.0"},"dependencies":{"tslib":"^2.6.2"},"sideEffects":false}');
